...
const NotFound = () => {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      // Load MorphSVGPlugin after GSAP
      ...
      morphScript.onload = () => {
        // Load CustomEase
        const easeScript = document.createElement('script');
        easeScript.src = '//s3-us-west-2.amazonaws.com/s.cdpn.io/16327/CustomEase.min.js?r=2';
        easeScript.async = true;
        document.body.appendChild(easeScript);
    ...
    return () => {
      // Clean up scripts
      document.body.querySelectorAll('script[src*="gsap"], script[src*="MorphSVGPlugin"], script[src*="CustomEase"]').forEach(script => {
  ...
  const initAnimation = () => {
    ...
    var mouthShape4 = "M149.2 116.7c-4.6 3.7-6.7 8.8-5.2 14.6.1.3.1.5.2.8.6 1.5 2.4 2.3 3.9 1.7l11.2-4.4 11.2-4.4c1.5-.6 2.3-2.4 1.7-3.9-.1-.3-.2-.5-.4-.7-2.8-5.2-8.2-7.2-14-6.9-3.6.2-5.9 1.1-8.6 3.2z";

    chatterTL = new window.TimelineMax({ paused: true, repeat: -1, yoyo: true });
    chatterTL
      .to(['#mouthBG', '#mouthPath', '#mouthOutline'], .1, { morphSVG: mouthShape4 }, "0")
      .to('#chin', .1, { y: 1.5 }, "0");

    yetiTL = new window.TimelineMax({ paused: true, repeat: -1, repeatDelay: 0, delay: 0 });
    yetiTL
      ...
      .addCallback(function () {
        chatterTL.pause();
        window.TweenMax.to(['#mouthBG', '#mouthPath', '#mouthOutline'], .1, { morphSVG: mouthShape1 }, "0");
      }, "3.2")
      .to(['#mouthBG', '#mouthPath', '#mouthOutline'], .25, { morphSVG: mouthShape2 }, "5")
      .to('#tooth1', .1, { y: -5 }, "5")
      .to('#armR', .5, { x: 10, y: 30, rotation: 10, transformOrigin: "bottom center", ease: window.Quad.easeOut }, "4")
      ...
      .to('#tooth1', .1, { y: 0 }, "9")
      .to('#armR', .5, { x: 0, y: 0, rotation: 0, transformOrigin: "bottom center", ease: window.Quad.easeOut }, "9")
    ...
    function goDark() {
      window.TweenMax.set('#light', { visibility: "hidden" });
      window.TweenMax.set('.lettersSide', { fill: lettersSideDark, stroke: lettersStrokeDark });
      window.TweenMax.set('.lettersFront', { fill: lettersFrontDark, stroke: lettersStrokeDark });
      window.TweenMax.set('#lettersShadow', { opacity: .05 });
      window.TweenMax.set('.hlFur', { fill: furDarkColor });
      window.TweenMax.set('.hlSkin', { fill: skinDarkColor });
    }

    function goLight() {
      window.TweenMax.set('#light', { visibility: "visible" });
      window.TweenMax.set('.lettersSide', { fill: lettersSideLight, stroke: lettersStrokeLight });
      window.TweenMax.set('.lettersFront', { fill: lettersFrontLight, stroke: lettersStrokeLight });
      window.TweenMax.set('#lettersShadow', { opacity: .2 });
      window.TweenMax.set('.hlFur', { fill: furLightColor });
      window.TweenMax.set('.hlSkin', { fill: skinLightColor });
    }
      ...
      <div className="yeti-wrapper">
        ...
        <svg id="lightSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 470">
          ...
          <g id="four04">
            ...
            <path className="lettersFront" stroke="#265D85" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2.5" fill="#67B1E0" d="M543.3 453.7l20.1 2.9-6 38.6-20-2.8-6.5 42.1-47.4-6.5 6.5-42.3-81.1-11.4 5.4-36.2 82.2-102.8 63.8 9.9-17 108.5zm-37.7-62.8c.2-1 .4-1.9.6-2.8l.6-2.7c.2-.9.4-1.7.6-2.6.2-.8.4-1.7.5-2.5l-1.2-.2c-.8 1.4-1.6 2.7-2.5 4.1s-1.7 2.7-2.5 4c-.8 1.3-1.7 2.7-2.5 4-.9 1.3-1.7 2.6-2.6 4-.9 1.3-1.8 2.6-2.7 4s-1.8 2.7-2.7 4-1.8 2.7-2.7 4L463.6 442l32.3 4.7 3.3-21.6c.1-.8.3-1.6.4-2.5.1-.8.3-1.7.4-2.6.1-.9.3-1.8.5-2.7.2-.9.3-1.9.5-2.9s.4-1.9.5-2.9c.2-1 .4-2 .6-2.9l.6-3 .6-3 .6-3 .6-3c.2-1 .4-2 .6-2.9.1-.8.3-1.8.5-2.8"/>
          </g>
        </svg>
      </div>
